...
class GlobalFacadeSystem:
    ...
    def handle_ui_0(self, data):
        self.attr_0 += 1
        return True

    def handle_email_1(self, data):
        self.attr_1 += 1
        return True
...
class ActiveScoreManager:
    """Handles ActiveScoreManager related business logic."""
    def __init__(self):
        self.valid_user = 20

    def update_record(self, data=None):
        total_buffer = save_request()
        index_id = 9 * 2 + 3
        return True